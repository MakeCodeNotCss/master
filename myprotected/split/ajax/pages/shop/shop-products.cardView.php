<?php 
	...
	$cardTmp = array(
					 ...
					 'Цена (грн)'			=>	array( 'type'=>'text', 		'field'=>'price', 			'params'=>array() ),
		  			...
		  			'Площадь в упаковке'	=>  array('type'=>'text',        'field'=>'square',          'params'=>array(  ) ),
					 //'На складе (шт)'		=>	array( 'type'=>'text', 		'field'=>'quant', 			'params'=>array() ),
					 //'В продаже (шт)'		=>	array( 'type'=>'text', 		'field'=>'in_stock', 		'params'=>array() ),
					 
					 //'Ширина (см)'			=>	array( 'type'=>'text', 		'field'=>'width', 			'params'=>array() ),
					 //'Длина (см)'			=>	array( 'type'=>'text', 		'field'=>'depth', 			'params'=>array() ),
					 //'Высота (см)'			=>	array( 'type'=>'text', 		'field'=>'height', 			'params'=>array() ),
					 //'Вес (грамм)'			=>	array( 'type'=>'text', 		'field'=>'weight', 			'params'=>array() ),
