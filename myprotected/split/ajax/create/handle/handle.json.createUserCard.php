<?php 
	...
	$letter = ( ($cardUpd['male'] == 'M' || $cardUpd['male'] == 0) ? "Уважаемый" : "Уважаемая");
	
	$letter .= " ".$cardUpd['name']." ".$cardUpd['fname']."! <br> Ваш аккаунт на сайте parquet-board.com успешно зарегистрирован! <br><hr><br>";
	
	$letter .= "<h4>Данные для входа авторизации:</h4>";
	
	$letter.= "<p><b>ADMIN PANEL</b>: <a href='http://parquet-board.com/myprotected/'>PARQUET BOARD ADMIN</a></p>";
	
	$letter.= "<p><b>Login</b>: ".$cardUpd['login']."</p>";
	$letter.= "<p><b>Password</b>: ".$pass."</p>";
	
	$ah->wp_send_letter($cardUpd['login'],"support@parquet-board.com","Успешная регистрация",$letter,"PARQUET-BOARD STORE");
