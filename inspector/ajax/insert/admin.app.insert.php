...
<body>
	<?php
		...
		$last_app_query = "SELECT id FROM next_admin_applications WHERE 1 ORDER BY id DESC LIMIT 1";
		...
		mkdir("../../../wpmanager/split/applications/app-".$last_app_id,0777);
		$controller->mtvc_Read_and_Copy_data_from_dir("../../../wpmanager/split/applications/app-N/","../../../wpmanager/split/applications/app-".$last_app_id."/");
