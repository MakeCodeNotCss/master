	...
	$result  = "
    			...
    			<div class='modalW' id='modalW-1'>
					<div class='confirmWrapper'>
						<h2 align='center'>Вы уверенны что хотите отменить заказ №".($orderId)." ?</h2>
						<table>
							<tr>
								<td><a href='javascript:void();' class='cancel' onclick=\"close_modal();\">Нет</a></td>
								<td><a href='javascript:void();' class='confirm' onclick=\"close_modal(); change_quick_order_status($orderId,5);\">Да</a></td>
							</tr>
						</table>
					</div>
				</div>
