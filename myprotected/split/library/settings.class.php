...
class settingsHelp extends BasicHelp
{
		...
		public function getAllMyAccounts()
		{
		...
		public function getMyAccount($item_id)
		{
		...
		public function getMyDelivery($item_id)
		{
		...
		public function getAccountsInfo($params=array())
		{
			$query = "SELECT * FROM [pre]my_accounts ORDER BY id LIMIT 10000";
