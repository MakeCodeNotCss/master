...
class ajaxHelp
{
	...
	// Send mail
	public function wp_send_letter($to_mail,$from,$subject_mail,$message_mail,$system="PARQUET-BOARD")
	{
		try
		{
			$date = date("d.m.y H:i");
		...
		public function send_letter($to_mail,$from,$subject_mail,$message_mail,$system="PARQUET-BOARD")
	{
		try
		{
			$date = date("d.m.y H:i");
